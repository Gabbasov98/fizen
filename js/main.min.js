let countrySelect=document.querySelectorAll(".country-select");countrySelect.forEach(e=>{let t=e.querySelector(".country-select__show"),n=e.querySelector(".country-select__current"),o=e.querySelectorAll(".country-item");function c(){e.classList.remove("_open")}t.onclick=function(){e.classList.toggle("_open")},o.forEach(e=>{e.onclick=function(){let t=e.getAttribute("data-img"),o=e.getAttribute("data-title");c(),n.innerHTML=`\n                <img src="${t}" alt="" class="country-item__img">\n                <div class="country-item__title">\n                    ${o}\n                </div>\n            `}}),document.addEventListener("click",t=>{t.composedPath().includes(e)||c()})});let benefitsModal=document.querySelector(".benefits-modal"),benefitsModalBtn=document.querySelector("._show-benefits-modal"),benefitsModalNav=document.querySelector(".benefits__nav");benefitsModalBtn&&(benefitsModalBtn.onclick=function(){benefitsModal.classList.add("_open"),setTimeout(()=>{document.addEventListener("click",e=>{e.composedPath().includes(benefitsModalNav)||benefitsModal.classList.contains("_open")&&benefitsModal.classList.remove("_open")})},1e3)});
...
function gallerySlider(){new Swiper(".gallery .swiper-container",{slidesPerView:"auto",spaceBetween:0,loop:!0,navigation:{nextEl:".gallery .swiper-button-next",prevEl:".gallery .swiper-button-prev"}})}gallerySlider();
